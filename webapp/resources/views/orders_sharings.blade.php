    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 p-0">
           <!-- CARROUSEL -->
          <div id="carouselOrdersShared"  class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
              <!-- item -->
              <div class="carousel-item active">
                <img class="d-block img-fluid w-100" style="width:256px; height:200px;" src="{{ asset('img/orders_sharings/303-divaniquattroopiuposti-80284-b-1.jpg') }}" atl="first slide" >
              ...
              <div class="carousel-item">
                <img class="d-block img-fluid w-100" style="width:256px; height:200px;" src="{{ asset('img/orders_sharings/199-mobilipercucina-89487-b-1.jpg') }}" data-holder-rendered="true">
                <div class="carousel-caption" style="background: rgba(0, 0, 0, 0.35);">
                  <h5>Cucina Lain</h4>
              ...
              <!-- item -->
              <div class="carousel-item">
                <img class="d-block img-fluid w-100" style="width:256px; height:200px;" src="{{ asset('img/orders_sharings/207-pianicottura-88876-b-1.jpg') }}" data-holder-rendered="true">
                <div class="carousel-caption" style="background: rgba(0, 0, 0, 0.35);">
...
<div class="py-5">
 ...
 <div class="col-6 col-md-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title">Divano Grace sconto fino a €650,00</h4>
              <p class="card-text">Forme di lusso, ricche decorazioni e contorni lisci.</p>
 ...
 <div class="col-6 col-md-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title">progetto Lane sconto fino a €1490,00</h4>
              <p class="card-text">Di gusto giovane e con un design rigoroso.</p>
              <h5 class="card-title">Euromobil</h5>
                <div class="progress" style="height: 20px; margin-bottom:20px;">
                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 25%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100">35%</div>
                </div>
...
<div class="card">
  ...
  <div class="card-body">
    <h4 class="card-title">Divano Grace sconto fino a €990,00</h4>
    <p class="card-text">Forme di lusso, ricche decorazioni e contorni lisci.</p>
    <h5 class="card-title">Euromobil</h5>
      <div class="progress" style="height: 20px; margin-bottom:20px;">
        <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 25%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100">35%</div>
