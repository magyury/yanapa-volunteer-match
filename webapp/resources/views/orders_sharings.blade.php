      ...
      <div class="row">
        ...
        <div class="col-md-6 p-0">
          ...
          <ol class="carousel-indicators">
            <li data-target="#carouselOrdersShared" data-slide-to="0" class="active"></li>
            <li data-target="#carouselOrdersShared" data-slide-to="1"></li>
            <li data-target="#carouselOrdersShared" data-slide-to="2"></li>
          </ol>
          -->
            <div class="carousel-inner" role="listbox">
              <!-- item -->
              <div class="carousel-item active">
                <img src="{{ asset('img/orders_sharings/303-divaniquattroopiuposti-80284-b-1.jpg') }}" atl="first slide" class="d-block img-fluid w-100">
              ...
              <div class="carousel-item">
                <img class="d-block img-fluid w-100" src="{{ asset('img/orders_sharings/199-mobilipercucina-89487-b-1.jpg') }}" data-holder-rendered="true">
                <div class="carousel-caption" style="background: rgba(0, 0, 0, 0.35);">
                  <h5>Cucina Lain</h4>
              ...
              <!-- item -->
              <div class="carousel-item">
                <img class="d-block img-fluid w-100" src="{{ asset('img/orders_sharings/207-pianicottura-88876-b-1.jpg') }}" data-holder-rendered="true">
                <div class="carousel-caption" style="background: rgba(0, 0, 0, 0.35);">
