...
class AuthController extends Controller
{
    ...
    */
    ...
    // REPLACED function __construct() WITH
    ...
    /* At the bottom of the controller, add these three functions after the create function.
    / The register function we are adding will override the register method inherited 
    / from the AuthenticatesAndRegistersUsers trait.
    */
