...
| Create the ActivationRepository class file in app/Repositories. 
| This class contains functions for generating activation tokens and updating the tables in the database.
